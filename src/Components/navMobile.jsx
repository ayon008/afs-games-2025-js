...
const NavMobile = () => {
    ...
    return (
        <div ref={wrapperRef} className={`dropdown dropdown-end 2xl:hidden xl:hidden lg:hidden block ${open ? 'dropdown-open' : ''}`}>
            <div tabIndex={0} role="button" aria-expanded={open} onClick={() => setOpen(v => !v)} className="btn m-1">

...
import image1 from '../../../../public/assets/chole.jpg';
import image2 from '../../../../public/assets/Antinio.jpg';
import image3 from '../../../../public/assets/another.jpg';
        ...
        <div className=''>
            <div className='max-h-[718px] min-h-[500px] 2xl:pt-[140px] xl:pt-[120px] flex flex-col'>
                <div className='m-auto'>
                    <h1 className={`${morgana.className} text-center lg:text-8xl text-5xl text-[#FFE500] uppercase`}>contact</h1>
                </div>
            </div>
            <div className='2xl:p-20 xl:p-20 p-10 rounded-t-[50px] bg-white'>
                <h2 className={`${morgana.className} uppercase text-center 2xl:text-7xl xl:text-5xl text-3xl text-[#FFE500]`}>AFS GAMES TEAM</h2>
                ...
                <h2 className={`${morgana.className} 2xl:my-20 xl:my-16 my-10 uppercase text-center 2xl:text-7xl xl:text-5xl text-3xl text-[#FFE500]`}>Social Media</h2>
